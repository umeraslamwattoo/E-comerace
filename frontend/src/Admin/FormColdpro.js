...
function FormColdpro() {
    ...
    const handleFormData = async () => {
        ...
        await fetch("http://localhost:5001/coldmodel", {
            method: "POST",
            body: formData,
        });
    ...
    <div>
        <div className='d-flex'>
                ...
                <div id='main-container'>
                    <h2 className='text-center-mainheading '>ADD NEW COLD PRODUCT</h2>
                    <div id='mainbox'>
