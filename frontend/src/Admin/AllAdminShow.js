...
function AllAdminShow() {
    ...
    var deleteAdmion = async (id) => {
        try {
            var response = await fetch(`http://localhost:5001/admin/${id}`, {
                method: "DELETE"
            });
            if (response.ok) {
                fetchApi();
    ...
    var fetchApi = async () => {
        var response = await fetch("http://localhost:5001/admin");
        ...
        <div>
                ...
                <div className='d-flex'>
                    ...
                    <div className='container'>
                        <h2 className='text-center-mainheading'>SHOW ALL ADMINS</h2>
